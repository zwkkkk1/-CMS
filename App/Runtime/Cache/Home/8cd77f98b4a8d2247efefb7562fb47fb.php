    ...
    <div class="nav-wrapper">
        <nav class="top-nav">
            <ul>
                ...
                <li><span class="glyphicon glyphicon-align-justify sidebar-trigger" style="color: #fff"></span></li>
                <?php } else {?>
                <li><span class="layout-btn" onclick="return confirm('确定退出');">退出</span></li>
...
<footer>
    <div class="foot fixed">
        ...
        <ul class="right-foot">
            <li><a href=""><img src="__PUBLIC__/Home/images/wechat.png"></a></li>
            <li><a href=""><img src="__PUBLIC__/Home/images/weibo.png"></a></li>
            <li><a href=""><img src="__PUBLIC__/Home/images/qq.png"></a></li>
        </ul>
    </div>
</footer>
<div class="mask"></div>
