    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="" class="editform" method="post" id="myform" name="myform">
                    <input type="hidden" name="id" id="id" value="<?php echo ($mesInfo["id"]); ?>">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th><i class="require-red">*</i>标题：</th>
                            <td>
                                <input class="common-text required" id="title" name="title" size="30"
                                       value="<?php echo ($mesInfo["title"]); ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>发布者：</th>
                            <td>
                                <input class="common-text required" id="author" name="author" size="30"
                                       value="<?php echo ($mesInfo["author"]); ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>板块：</th>
                        ...
                        <tr>
                            <th>时间：</th>
                            <td><input type="text" value="<?php echo ($mesInfo["time"]); ?>" id="time" name="time"
                                       style="cursor: pointer"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>内容：</th>
                            <td>
                                <textarea id="content" name="content"><?php echo ($mesInfo["content"]); ?></textarea>
                            </td>
                        </tr>
                        <!--<tr>-->
                            ...
                            <!--<td>-->
                                ...
                                <!--<img src="__PUBLIC__/captcha.php" id="verify-img" height="30" width="100"-->
                                     ...
                                     <!--onclick='this.src="__PUBLIC__/captcha.php?"+Math.random()'/>-->
                            <!--</td>-->
                        <!--</tr>-->
                        <tr>
                            <th></th>
