    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list">
                ...
                <span class="crumb-step">&gt;</span>
                <span class="crumb-name">新增模块</span>
            </div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <table class="insert-tab" width="100%">
                    <input value="<?php echo $_GET['previd'];?>" type="hidden" id="previd">
                    <tbody>
                    <tr>
                        <th><i class="require-red">*</i>模块：</th>
                        <td>
                            <input class="common-text required" id="name" name="name" size="30" type="text" value="">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <input class="btn btn-primary btn6 mr10 add-cate" value="提交" type="button">
