    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list">
                ...
                <span class="crumb-step">&gt;</span>
                <span class="crumb-name">修改管理员</span>
            </div>
        </div>
                ...
                <table class="insert-tab" width="100%">
                    ...
                    <input type="hidden" id="id" value="<?php echo $_GET['id'];?>">
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="username" name="username" size="30" type="text" value="<?php echo ($info["username"]); ?>">
                            </td>
                        </tr>
                        <tr>
                            <th>输入原密码：</th>
                        ...
                        <tr>
                            <th></th>
                            <td>
                                <input class="btn btn-primary btn6 mr10 edit-admin" value="提交" type="button">
...
$('.edit-admin').click(function() {
    ...
    $.ajax({
        url: URL,
        data: {username: username, password: pwd, newpassword: newpwd, id: $('#id').val()},
        dataType: 'json',
        type: 'post',
